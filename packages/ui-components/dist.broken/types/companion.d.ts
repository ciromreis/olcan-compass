export type CompanionType = 'institutional_escapee' | 'scholarship_cartographer' | 'career_pivot' | 'global_nomad' | 'technical_bridge_builder' | 'insecure_corporate_dev' | 'exhausted_solo_mother' | 'trapped_public_servant' | 'academic_hermit' | 'executive_refugee' | 'creative_visionary' | 'lifestyle_optimizer';
