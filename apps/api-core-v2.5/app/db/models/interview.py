...
class InterviewSession(Base):
    ...
    source_narrative_id: Mapped[uuid.UUID | None] = mapped_column(ForeignKey("narratives.id", ondelete="SET NULL"), nullable=True, index=True)
    ...
    source_narrative_title: Mapped[str | None] = mapped_column(String(200), nullable=True)
