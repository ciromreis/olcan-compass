...
# Master Dossier Export (temporarily mounted via quest.py for reliability)
# from app.api.routes.dossier_export import router as dossier_export_router
...
def _mount_all_routes(router: APIRouter) -> None:
    ...
    # Master Dossier Export now via quest.py endpoint
