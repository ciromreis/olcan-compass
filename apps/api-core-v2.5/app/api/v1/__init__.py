...
from app.api.v1 import auth, users, companions, marketplace, leaderboard, documents, dossiers, enhanced_forge
...
api_router.include_router(enhanced_forge.router, tags=["enhanced-forge"])  # has own prefix /enhanced-forge
