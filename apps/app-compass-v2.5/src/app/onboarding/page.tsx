      ...
      <div className="mx-auto max-w-5xl space-y-12">
        <section className="relative overflow-hidden rounded-[3rem] border border-bone-500/10 bg-white/50 p-10 shadow-glass backdrop-blur-3xl md:p-16">
          <div className="relative flex flex-col gap-10 md:flex-row md:items-start md:justify-between">
            <div className="max-w-2xl space-y-6">
              <div className="inline-flex items-center gap-2 rounded-full border border-gold-500/20 bg-gold-500/10 px-4 py-2 text-caption font-semibold uppercase tracking-wide text-gold-600">
              ...
              <p className="max-w-xl text-xl leading-relaxed text-ink-400 font-medium">
                O v2.5 não é um jogo. É uma <span className="text-gold-500 font-semibold">Plataforma de Execução Topográfica</span>. 
            ...
            <div className="min-w-[260px] rounded-[2.5rem] border border-bone-500/10 bg-white/80 p-8 shadow-glass-sm mt-8 md:mt-0">
              <div className="flex items-center justify-between text-caption font-semibold uppercase tracking-wide text-ink-300">
              ...
              <div className="mt-6 text-sm text-ink-500 font-bold uppercase tracking-widest text-caption">
        ...
        <section className="rounded-[3rem] border border-bone-500/10 bg-white/30 p-8 shadow-glass-sm backdrop-blur-2xl md:p-12">
            ...
            <div className="grid gap-12 lg:grid-cols-2">
              <div className="space-y-10">
                <div className="space-y-4">
                  <p className="text-caption font-semibold uppercase tracking-wide text-gold-500">Início da Jornada</p>
              ...
              <div className="p-12 rounded-[3rem] border border-ink-900 bg-ink-950 text-white shadow-2xl relative overflow-hidden">
                ...
                <div className="relative z-10 space-y-8">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="text-caption font-semibold uppercase tracking-wide text-gold-500/70">Arquitetura de Produto</p>
          ...
          {etapa === "perfil" && (
            <div className="space-y-12">
              <div className="space-y-4">
                <p className="text-caption font-semibold uppercase tracking-wide text-gold-500">Etapa 02</p>
                ...
                <p className="text-xl leading-relaxed text-ink-400 font-medium max-w-3xl">
                  Escolha o arquétipo que servirá de base para as animações, tom de voz e prioridades da sua <span className="text-gold-500 font-semibold px-1.5 py-0.5 bg-gold-500/5 rounded-lg">Aura</span>.
                </p>
              </div>
                  ...
                  >
                    ...
                    <div className="flex flex-wrap gap-2">
                      {item.foco.slice(0, 2).map((tag) => (
                        <span key={tag} className="px-3 py-1 rounded-full bg-bone-50 text-caption font-semibold uppercase tracking-widest text-ink-300">
                          {tag}
                        </span>
                      ))}
                    </div>
              ...
              <div className="p-10 rounded-[3rem] border border-bone-500/10 bg-bone-50/30 backdrop-blur-xl space-y-6">
                <div className="flex flex-col md:flex-row md:items-center gap-6">
                  <div className="flex-1">
                    <label className="block text-caption font-semibold uppercase tracking-wide text-ink-300 mb-4 ml-2">Como chamaremos sua manifestação Aura?</label>
                    <input
                      type="text"
                      value={nomeAura}
                  ...
                  {resumo && (
                    <div className="p-6 rounded-3xl bg-ink-950 text-white min-w-[300px] flex items-center gap-4">
                      ...
                      <div>
                        <div className="text-caption font-semibold uppercase tracking-widest opacity-40">Ativando Arquétipo</div>
          ...
          {etapa === "preferencias" && (
            <div className="grid gap-12 lg:grid-cols-2">
              <div className="space-y-10">
                <div className="space-y-4">
                  <p className="text-caption font-semibold uppercase tracking-wide text-gold-500">Etapa 03</p>
                  ...
                  <p className="text-xl leading-relaxed text-ink-400 font-medium">
                    Personalize como a <span className="text-gold-500 font-semibold">Aura</span> deve interagir com sua rotina de execução.
                  </p>
                </div>
                  ...
                  <div className="relative z-10 space-y-10 w-full">
                    <div className="flex flex-col items-center gap-6">
                      ...
                      <div className="space-y-2">
                        <div className="text-caption font-semibold uppercase tracking-wider text-gold-500/60 leading-none">Aura Identificada</div>
                    ...
                    <div className="space-y-6">
                      <div className="space-y-1">
                        <div className="text-caption font-semibold uppercase tracking-wide text-white/30">Configuração de Postura</div>
        ...
        <div className="flex items-center justify-between gap-6 pt-4">
          <button
            type="button"
            onClick={voltar}
            className="h-16 px-8 rounded-2xl border border-bone-500/20 bg-white/50 font-semibold text-caption uppercase tracking-widest text-ink-300 transition-all hover:bg-white hover:text-ink-950 shadow-glass-sm flex items-center gap-3 group"
          >
          ...
          <button
            ...
            className="h-16 px-10 rounded-2xl bg-ink-950 text-white font-semibold text-caption uppercase tracking-widest transition-all hover:bg-gold-500 hover:text-ink-950 shadow-2xl flex items-center gap-3 group disabled:opacity-30 disabled:cursor-not-allowed"
          >
