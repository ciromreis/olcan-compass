...
const FAQS = [
  { q: "O Compass é gratuito?", a: "Sim, o plano Lite é 100% gratuito e inclui perfil de mobilidade, 1 rota ativa, Score de Certeza e Taxa de Perda por Inércia. Planos pagos desbloqueiam IA avançada, simulador de entrevista e marketplace." },
  ...
  { q: "Como funciona o pagamento protegido do marketplace?", a: "Quando você contrata um profissional, o valor fica retido em garantia até que o serviço seja entregue e aprovado. Se houver disputa, nossa equipe media a resolução." },
