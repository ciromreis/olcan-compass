...
const PLANS = [
  {
    ...
    features: [
      { text: "Perfil de mobilidade completo", included: true },
      ...
      { text: "Marketplace com pagamento protegido", included: false },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Marketplace com pagamento protegido", included: true },
