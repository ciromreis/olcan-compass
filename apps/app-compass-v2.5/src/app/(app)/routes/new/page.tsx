        ...
        <div className="space-y-4">
          ...
          <div className="grid gap-3">
            {ROUTE_TYPES.map((type) => (
              <button key={type.id} onClick={() => setSelected(type.id as RouteIntentType)} className={`card-surface p-5 flex items-center gap-4 text-left transition-all ${selected === type.id ? "ring-2 ring-brand-500 bg-brand-50/50" : "hover:-translate-y-0.5"}`}>
