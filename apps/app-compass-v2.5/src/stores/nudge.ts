...
export const ARCHETYPES_DB: Record<AuraArchetype, ArchetypeMetadata> = {
  ...
  Alchemist: { id: "Alchemist", name: "O Alquimista", description: "Transforma recursos comuns em valor extraordinário.", motivators: ["Transformação", "Sinergia"], strengths: ["Adaptabilidade", "Otimização de valor"], color: "text-slate-500" },
  ...
  Catalyst: { id: "Catalyst", name: "O Catalisador", description: "Acelera reações e alavanca o potencial alheio.", motivators: ["Impacto", "Velocidade"], strengths: ["Energia inspiracional", "Empurrão inicial"], color: "text-slate-500" },
