  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        shadow && 'shadow-[0_8px_32px_rgba(10,13,26,0.1),0_2px_8px_rgba(10,13,26,0.05)]',
        border && 'border border-white/30',
        hover && 'hover:scale-[1.01] hover:shadow-[0_16px_48px_rgba(10,13,26,0.15),0_4px_16px_rgba(10,13,26,0.08)] transition-all duration-300',
        className
      )}
      animate={animated ? {
        y: [0, -3, 0],
