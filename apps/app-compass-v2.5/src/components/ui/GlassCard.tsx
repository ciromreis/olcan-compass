...
export const GlassCard: React.FC<GlassCardProps> = ({
  ...
  const variantClasses = {
    default: "bg-surface-glass backdrop-blur-2xl",
    dark: "bg-ink-500/10 backdrop-blur-2xl",
    light: "bg-surface-card/40 backdrop-blur-xl",
    olcan: "bg-gradient-to-br from-bone-50/90 to-bone-100/80 backdrop-blur-2xl",
  };
  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        shadow &&
          "shadow-[0_8px_32px_rgba(10,13,26,0.1),0_2px_8px_rgba(10,13,26,0.05)]",
        border && "border border-white/30",
        hover &&
          "hover:scale-[1.01] hover:shadow-[0_16px_48px_rgba(10,13,26,0.15),0_4px_16px_rgba(10,13,26,0.08)] transition-all duration-300",
        className,
      )}
      animate={
        animated
