        ...
        <div className="relative">
          ...
          <input
            ...
            className={cn(
              ...
              "focus:outline-none focus:ring-2 focus:ring-slate-400 focus:border-transparent focus:bg-white",
              "transition-all duration-fast",
              "py-2.5 shadow-sm",
              icon ? "pl-10 pr-4" : "px-4",
              error ? "border-error ring-2 ring-error/20" : "border-slate-200 hover:border-slate-300",
              className
            )}
