...
export default function UnifiedNavigation() {
  ...
  const navItems: NavItem[] = [
    ...
    },
    {
      id: 'marketplace',
      label: 'Mercado',
      href: 'https://olcan.com.br/marketplace',
  ...
  return (
    <>
      {/* Desktop Navigation */}
      <nav className="hidden lg:block fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-xl border-b border-brand-200 shadow-sm">
          ...
          <div className="flex items-center justify-between h-20">
            ...
            <Link href="/" className="flex items-center space-x-3">
              <motion.div
                ...
                className="w-10 h-10 bg-gradient-to-br from-brand-400 to-brand-600 rounded-xl flex items-center justify-center shadow-lg shadow-brand-500/20"
              >
