      ...
      <aside className="w-full md:w-64 bg-slate-900 border-r border-white/5 flex flex-col md:min-h-screen sticky top-0 md:h-screen">
        <div className="p-6 border-b border-white/5 flex items-center justify-between">
          <Link href="/dashboard" className="flex items-center gap-2">
            <div className="w-8 h-8 rounded bg-nanobanana-500 text-slate-900 flex items-center justify-center font-heading font-black text-xl">O</div>
        ...
        <nav className="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
          ...
          <Link href="#" className="flex items-center gap-3 px-4 py-3 rounded-xl text-slate-400 hover:text-white hover:bg-white/5 font-medium transition-colors">
            ...
            <span className="ml-auto w-5 h-5 rounded-full bg-nanobanana-500 text-slate-900 text-[10px] font-bold flex items-center justify-center">2</span>
          </Link>
        </nav>
