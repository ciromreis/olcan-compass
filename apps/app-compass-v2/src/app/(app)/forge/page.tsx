              ...
              <div className="flex flex-col gap-6 md:flex-row md:items-center">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div className="mt-2 flex flex-wrap gap-4">
                    <span className="rounded-full bg-[#001338]/5 px-3 py-1 text-[10px] font-bold uppercase tracking-widest text-[#001338]/80">
                  ...
                  {doc.competitivenessScore !== null && (
                    <div className="text-right">
                      <div className="mb-1 flex items-center justify-end gap-1.5">
                        ...
                        />
                        <span className="font-heading text-h4 font-black text-[#001338]">
                          {doc.competitivenessScore}
                        </span>
                      </div>
                      <p className="text-[10px] font-bold uppercase tracking-widest text-[#001338]/30">
                        Score Olcan
                      </p>
                    </div>
                  )}
