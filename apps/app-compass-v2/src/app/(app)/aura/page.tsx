...
import { Heart, Zap, Sparkles, Shield, Trophy, Target, Orbit, Fingerprint, Activity } from 'lucide-react'
...
const AURA_ACTIVITIES: { type: CareActivityType; icon: any; label: string; xpReward: number; energyCost: number; description: string }[] = [
...
export default function AuraPage() {
  ...
  const evolutionProgress = useEvolutionProgress()
