...
import { Trophy, ChevronLeft, Sparkles, Star, Zap } from 'lucide-react'
    ...
    <>
      ...
      <div className="min-h-screen bg-surface-bg pb-24">
        ...
        <div className="fixed top-0 left-0 w-full h-full overflow-hidden pointer-events-none -z-10">
          <div className="absolute top-[10%] left-[5%] w-64 h-64 bg-gold-400/5 rounded-full blur-[120px]" />
          <div className="absolute bottom-[20%] right-[10%] w-96 h-96 bg-gold-500/5 rounded-full blur-[150px]" />
        </div>
