  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <div className="card-surface p-6">
        <h3 className="font-heading text-h4 text-text-primary mb-4 flex items-center gap-2"><Sliders className="w-5 h-5 text-brand-500" /> Parâmetros</h3>
        <div className="space-y-5">
          <div>
            <label className="block text-body-sm font-medium text-text-primary mb-1.5">Orçamento (BRL)</label>
            <input type="range" min="5000" max="100000" step="1000" value={budget} onChange={(e) => setBudget(e.target.value)} className="w-full accent-brand-500" />
          ...
          <div>
            ...
            <input type="range" min="3" max="36" step="1" value={timeline} onChange={(e) => setTimeline(e.target.value)} className="w-full accent-brand-500" />
          ...
          <div>
            ...
            <select defaultValue={route.country} className="w-full px-4 py-2.5 rounded-lg border border-cream-500 bg-white text-text-primary focus:outline-none focus:ring-2 focus:ring-brand-400">
      ...
      <div className="card-surface p-6">
        ...
        <div className="grid grid-cols-3 gap-4 text-center">
          <div><p className="text-caption text-text-muted mb-1">Progresso</p><p className="font-heading text-h2 text-brand-500">{Math.round(progress)}%</p></div>
      ...
      <div className="flex gap-3">
        <button className="flex-1 inline-flex items-center justify-center gap-2 px-4 py-3 rounded-lg bg-brand-500 text-white font-heading font-semibold hover:bg-brand-600 transition-colors">
