...
export function CommunityQuestionForm({
  ...
  return (
    <section className="card-surface p-5 space-y-4">
      ...
      <button onClick={onSubmit} className="inline-flex items-center gap-2 rounded-lg bg-brand-500 px-4 py-2.5 text-body-sm font-semibold text-white transition-colors hover:bg-brand-600">
