          ...
          <div className="px-6 py-8 border-b border-ink-500/5">
            <Link href="/dashboard" className="flex items-center gap-3 group">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[10px] uppercase tracking-[0.2em] text-ink-300 font-bold opacity-70">Core Engine 2.5</span>
              </div>
            </Link>
          </div>
            ...
            {navSections.map((section) => (
              <div key={section.id} className="space-y-2">
                <div className="px-3 mb-4">
                  <p className="text-[10px] font-bold uppercase tracking-[0.25em] text-ink-300 opacity-60">
                    {section.label}
                  </p>
                </div>
          ...
          <div className="mt-auto p-4 border-t border-ink-500/5 bg-ink-500/5">
            <div className="flex items-center gap-3 p-3 rounded-[1.5rem] bg-white/40 border border-white/60">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[10px] text-ink-300 font-medium truncate">Assinatura Basic</p>
              </div>
              <button 
