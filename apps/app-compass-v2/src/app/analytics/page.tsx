...
import { GlassCard, GlassButton, ProgressBar, GlassModal } from '@olcan/ui-components'
...
const DocumentAnalytics = () => {
  ...
  const analyzeDocument = async () => {
    ...
    setTimeout(() => {
      ...
      const characters = document.length
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-foreground/60">
            Analyze your documents for YouTube content creation
          </p>
        </motion.div>
