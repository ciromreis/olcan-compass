              ...
              >
                <GlassCard className="p-6 relative overflow-hidden">
                  ...
                  <div className="relative z-10 flex items-start gap-4">
                    <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-yellow-500 to-orange-500 flex items-center justify-center flex-shrink-0 shadow-lg shadow-yellow-500/50">
                    ...
                    <div className="flex-1">
                      <div className="flex items-start justify-between mb-2">
                        ...
                        <span className="px-3 py-1 rounded-full bg-yellow-500/20 text-yellow-600 text-xs font-semibold">
                          {ability.type}
                        </span>
                      </div>
