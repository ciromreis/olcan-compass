            ...
            <div className="bg-ink-950/80 backdrop-blur-2xl border border-bone-500/10 rounded-2xl p-6 shadow-2xl">
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  <p className="text-[10px] uppercase font-bold tracking-widest text-gold-500">
  ...
  return (
    <div className="flex flex-col">
      <div className="flex items-center space-x-1 mb-1">
        ...
        <span className="text-[10px] uppercase font-semibold text-bone-500 tracking-wider font-mono">{label}</span>
      </div>
...
export function AuraAvatar({
  ...
  return (
    <div className="relative inline-flex items-center justify-center">
      ...
      {showLevel && level && (
        <div className="absolute -bottom-1 -right-1 w-5 h-5 rounded-full bg-gold-500 flex items-center justify-center text-[10px] font-black text-ink-950 border border-ink-950">
          {level}
        </div>
      )}
    </div>
...
export function EvolutionBadge({ 
  ...
  return (
    ...
    >
      ...
      <span className="text-xs font-black uppercase tracking-widest text-bone-300">{visual.label}</span>
    </div>
  )
}
