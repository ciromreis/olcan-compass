      ...
      <div className="card-surface p-10 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-6 mb-8">
          <div className="flex items-center gap-2 text-body-sm text-text-secondary">
            <Clock className="w-4 h-4 text-moss-500" /> ~10 minutos
          </div>
          <div className="flex items-center gap-2 text-body-sm text-text-secondary">
            <Shield className="w-4 h-4 text-moss-500" /> 100% confidencial
          </div>
          <div className="flex items-center gap-2 text-body-sm text-text-secondary">
            <Sparkles className="w-4 h-4 text-moss-500" /> Análise por IA
          </div>
        </div>
        <Link href="/profile/psych/calibration" className="inline-flex items-center gap-2 px-8 py-4 rounded-xl bg-moss-500 text-white font-heading font-bold hover:bg-moss-600 transition-colors shadow-md">
