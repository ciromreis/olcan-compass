    ...
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <div className="card-surface p-6 space-y-4">
        ...
        <div className="grid gap-3 rounded-xl border border-cream-300 bg-cream-50 p-4 md:grid-cols-2">
          <div>
            <p className="text-[11px] font-semibold uppercase tracking-[0.08em] text-text-muted">Nome</p>
            <p className="text-body-sm text-text-primary">{route.name}</p>
          </div>
          <div>
            <p className="text-[11px] font-semibold uppercase tracking-[0.08em] text-text-muted">Tipo</p>
            <p className="text-body-sm text-text-primary">{route.type}</p>
          </div>
          <div>
            <p className="text-[11px] font-semibold uppercase tracking-[0.08em] text-text-muted">País</p>
            <p className="text-body-sm text-text-primary">{route.country}</p>
          </div>
          <div>
            <p className="text-[11px] font-semibold uppercase tracking-[0.08em] text-text-muted">Timeline</p>
            <p className="text-body-sm text-text-primary">{route.timeline}</p>
          </div>
          <div>
            <p className="text-[11px] font-semibold uppercase tracking-[0.08em] text-text-muted">Budget</p>
            <p className="text-body-sm text-text-primary">{route.budget}</p>
          </div>
          <div>
            <p className="text-[11px] font-semibold uppercase tracking-[0.08em] text-text-muted">Criada em</p>
