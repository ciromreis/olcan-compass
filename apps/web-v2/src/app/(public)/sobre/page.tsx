    ...
    <section className="max-w-4xl mx-auto px-6 py-20">
      <div className="text-center mb-16">
        <div className="w-16 h-16 rounded-2xl bg-moss-50 flex items-center justify-center mx-auto mb-6">
          <Compass className="w-8 h-8 text-moss-500" />
        </div>
      ...
      <div className="space-y-8 mb-16">
        ...
        <div className="card-surface p-8">
          ...
          <p className="text-body text-text-secondary mb-4">O Compass é construído sobre o conceito de <em className="text-emphasis text-moss-500">Metamodern Experience Design (MMXD)</em> — a interseção entre precisão clínica e empatia humana. Cada tela, cada métrica, cada interação é desenhada para reduzir ansiedade e aumentar agência.</p>
          <div className="grid sm:grid-cols-3 gap-4">
            ...
            <div className="flex items-start gap-3">
              <Code className="w-5 h-5 text-moss-500 mt-0.5 flex-shrink-0" />
