    ...
    <>
      <section className="max-w-4xl mx-auto px-6 py-20">
        <div className="text-center mb-16">
          <p className="text-caption font-heading font-semibold tracking-widest uppercase text-moss-400 mb-3">Passo a passo</p>
        ...
        <div className="space-y-12">
          {STEPS.map((step) => (
            <div key={step.num} className="card-surface p-8 flex gap-6 items-start">
              <div className="flex-shrink-0 w-14 h-14 rounded-xl bg-moss-50 flex items-center justify-center">
                <step.icon className="w-6 h-6 text-moss-500" />
              </div>
              <div>
                <p className="text-caption font-heading font-bold text-moss-400 mb-1">Etapa {step.num}</p>
      ...
      <section className="max-w-4xl mx-auto px-6 pb-20">
        <div className="card-surface p-12 text-center bg-gradient-to-br from-moss-500 to-moss-700 noise-overlay relative overflow-hidden">
          <h2 className="font-heading text-h2 text-white mb-4 relative z-10">Pronto para começar?</h2>
          <a href="/register" className="relative z-10 inline-flex items-center gap-2 px-8 py-4 rounded-xl bg-white text-moss-600 font-heading font-bold hover:bg-cream-100 transition-colors shadow-lg">
