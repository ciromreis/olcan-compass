  ...
  return (
    <section className="max-w-4xl mx-auto px-6 py-20">
      <div className="text-center mb-16">
        <div className="w-16 h-16 rounded-2xl bg-moss-50 flex items-center justify-center mx-auto mb-6">
          <Brain className="w-8 h-8 text-moss-500" />
        </div>
      ...
      <div className="grid md:grid-cols-3 gap-6 mb-12">
        <div className="card-surface p-6 text-center">
          <Clock className="w-6 h-6 text-moss-500 mx-auto mb-3" />
        ...
        <div className="flex flex-col md:flex-row items-center gap-6">
          <div className="flex-1">
            ...
            <ul className="space-y-2 text-body text-text-secondary">
              <li className="flex items-start gap-2"><Target className="w-4 h-4 text-moss-500 mt-1 flex-shrink-0" />Score de Certeza personalizado (0–100)</li>
              <li className="flex items-start gap-2"><Target className="w-4 h-4 text-moss-500 mt-1 flex-shrink-0" />Mapa de medos e bloqueios identificados</li>
              <li className="flex items-start gap-2"><Target className="w-4 h-4 text-moss-500 mt-1 flex-shrink-0" />Custo de Inação diário calculado (R$/dia)</li>
              <li className="flex items-start gap-2"><Target className="w-4 h-4 text-moss-500 mt-1 flex-shrink-0" />Recomendação de rota com base no seu perfil</li>
            </ul>
          </div>
          <a href="/register" className="flex-shrink-0 inline-flex items-center gap-2 px-8 py-4 rounded-xl bg-moss-500 text-white font-heading font-bold hover:bg-moss-600 transition-colors shadow-md">
