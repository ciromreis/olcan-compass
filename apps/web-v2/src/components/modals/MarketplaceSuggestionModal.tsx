      ...
      <div className="relative bg-white rounded-2xl shadow-xl max-w-md w-full p-6">
        ...
        <div className="p-4 rounded-xl bg-cream-50 mb-4">
          <div className="flex items-center gap-3 mb-2">
            <div className="w-10 h-10 rounded-full bg-brand-50 flex items-center justify-center text-brand-500 font-heading font-bold">AL</div>
            <div>
          ...
          <div className="flex gap-3 text-caption text-text-muted">
            ...
            <span className="flex items-center gap-1 text-brand-500"><Shield className="w-3 h-3" />PEI: 92</span>
          </div>
        </div>
        <Link href="/marketplace/provider/p1" onClick={onClose} className="w-full inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl bg-brand-500 text-white font-heading font-semibold hover:bg-brand-600 transition-colors">
